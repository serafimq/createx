  ...
  class n {
    ...
    events() {
      this.modal && (document.addEventListener("click", function (t) {
        ...
        if (e) {
          let t = e.dataset.graphPath, o = e.dataset.graphAnimation, n = e.dataset.graphSpeed;
    ...
    focusCatch(t) {
      const e = this.modalContainer.querySelectorAll(this._focusElements), o = Array.prototype.slice.call(e),
